/**
 * @filename main.c
 * @description DuLinkedList test file
 * @author 许继元
 * @date 2020/4/24
 */
...
int main() {
    ...
    while (SUCCESS) {
        ...
        printf(">>> 8.Exit.                \n");
        printf("---------------------------\n");
        if (flag) TraverseList_DuL(head, visit); // Print LinkedList.
        ...
        switch (InputNumber()) {
            ...
            case 2:
                if (flag) TraverseList_DuL(head, visit);
                else printf("No LinkedList.\n");
                break;
            case 3:
            ...
            case 7:
                if (flag) {
                    ...
                    if (temp) printf("What you find is %d.\n", temp->data);
                } else printf("No LinkedList.\n");
                break;
            case 8:
                exit(0);
