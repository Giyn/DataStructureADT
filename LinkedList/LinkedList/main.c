/**
 * @filename main.c
 * @description LinkedList test file
 * @author 许继元
 * @date 2020/4/24
 */
...
int main() {
    ...
    while (SUCCESS) {
        ...
        printf(">>> 13.Exit.               \n");
        printf("---------------------------\n");
        if (flag) TraverseList(head, visit); // Print LinkedList.
        else printf("No LinkedList.\n");
        printf("---------------------------\n");
        ...
        switch (InputNumber()) {
            case 1:
                ...
                break;
            case 2:
                if (flag) TraverseList(head, visit);
                else printf("No LinkedList.\n");
                break;
            case 3:
                head = InitList(head);
            ...
            case 7:
                ...
                break;
            case 8:
                if (flag) head = ReverseList(head);
                else printf("No LinkedList.\n");
                break;
            case 9:
                if (flag) head = ReverseEvenList(head);
                else printf("No LinkedList.\n");
                break;
            case 10:
                if (flag) {
                    ...
                    if (LinkedList_length(head) % 2 == 0) printf("The data of middle Node is %d\n", mid->data);
