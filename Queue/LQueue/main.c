...
int main() {
    ...
    while (1) {
        ...
        printf(">>> 10.Exit      \n");
        printf("-----------------\n");
        if (flag) TraverseLQueue(q, &LPrint);
        ...
        switch (InputNumber()) {
            ...
            case 3:
                if (q->front == NULL) {
                    printf("Now there is no queue.\n");
                    break;
                } else if (IsEmptyLQueue(q)) printf("Now the queue is empty.\n");
                else DeLQueue(q);
                break;
            case 4:
                if (q->front == NULL) {
                    ...
                    if (IsEmptyLQueue(q)) printf("Now the queue is empty.\n");
                    else {
                        ClearLQueue(q);
            ...
            case 7:
                if (q->front == NULL) {
                    ...
                    if (IsEmptyLQueue(q)) printf("It is empty.\n");
